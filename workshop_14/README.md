...
| --- | --- | --- | --- | --- |
| **Фотографія** | `forest.jpg` | JPEG | 1.17 MB | Фото лісу, багато деталей і градієнтів. |
| **Скріншот** | `screenshot.png` | PNG | 92.2 KB | Інтерфейс із текстом і пласкими кольорами. |
| **Графіка** | `spotify.jpg` | JPEG | 110 KB | Логотип, мінімальна кількість кольорів. |
